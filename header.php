<div class="header-top">
            <div class="container">
                <div class="header-top-area">
                    <ul class="left">
                        <li>
                            <i class="far fa-clock"></i> 8:00am - 7:00pm Lun - Vier - Sab
                        </li>
                        <li>
                            <a href="tel:3122235788"><i class="fas fa-phone-alt"></i> 312-223-5788 </a>
                        </li>
                        <li>
                        <a href="https://check-in.cerifundacion.com/aceptacionConsentimientos" target="_blank"><i class="fas fa-id-card"></i>Check-In Ceri </a>
                        </li>
                    </ul>
                    <ul class="social-icons">
                        ...
                        <li>
                            <a href="https://maps.app.goo.gl/NhJffwF3JmqJqz3Y7" target="_blank" title="Navegar con Google Maps"><i class="fas fa-map"></i></a>
                        </li>
                    </ul>
                </div>
            </div>
